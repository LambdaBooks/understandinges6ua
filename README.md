...
> Перекладено з дозволу [No Starch Press][no-starch-press] та [Нікoласа Закаса](https://www.nczonline.net/).  
...
* додаткові можливості для зберігання даних з допомогою sets, maps та ін.;
