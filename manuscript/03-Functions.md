...
Arrow–функції є тимчасовими, тому не можуть бути використаними для завдання типів — це наслідок відсутності властивості `prototype`, яку мають звичайні функції. Якщо ви спробуєте використати оператор `new` з arrow–функцією, ви отримаєте помилку, як у цьому прикладі:
...
Як приклад, такий код легко буде оптимізований, оскільки він відповідає всім трьом критеріям:
...
Залишкові параметри дозволяють вам отримати масив, в якому будуть зберігатись решта переданих параметрів. Використання реального масиву та можливість визначати, які параметри мають бути включені, робить залишкові параметри набагато гнучкіше рішенням, ніж `arguments`.
